...
img2 = img[int(loc[KHEIGHT] * WuDongTool.RESTAURANT_TOP):,
       int(loc[KWIDTH] * WuDongTool.RESTAURANT_LEFT):]
# img2 = img[int(loc[KHEIGHT] * WuDongTool.RESTAURANT_3_TOP):,
#        int(loc[KWIDTH] * WuDongTool.RESTAURANT_3_LEFT):]
cv2.imshow("1", img2)
cv2.waitKey(0)
